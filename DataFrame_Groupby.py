...
avgRatings = avgRatings.sort_values(['movie_id', 'title']).mean()
...
sortRatingsField_NA = cloneDF(mergeRatings)
sortRatingsField_NA = sortRatingsField.groupby(['movie_id', 'title'])['rating'].agg(
